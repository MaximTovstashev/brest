...
Method.prototype.onRequest = function(req, res){
    ...
    _.each(req.query,function(value, filter){
        if (this.filters && this.filters[filter]){
            ...
            if (rd.filters[filter].replaceMe && (value=='me' || value=='mine')) {
    ...
    async.each(this._extensions.beforeHandler, function(extension, callback){
 ...
 * @param extension
 */
Method.prototype.use = function(extension){
    var self = this;
    if (extension.method) {
