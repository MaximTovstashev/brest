...
class Method extends EventEmitter{
    ...
    constructor(brest, description) {
        ...
        const uri = "/v" + description.version + "/" + description.noun + (description.uri?"/" + description.uri:"");
        ...
        const tooBusyString = this._brest.getSetting('application') + " is too busy to reply";
        const tooBusyEnabled = this._brest.getSetting('toobusy.enabled', true);
