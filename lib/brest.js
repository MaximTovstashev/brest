...
var Brest = function(settings){
    ...
    self.bindFile = function(fileName, callback){
        if (_.isString(fileName)) {
            ...
            console.log("ERROR: Can't use", fileName, "as a legit path");
    ...
    self.use = function(extensions) {
        function proceedWithExtensions() {
            ...
            async.eachSeries(extensions, function (extension, callback) {
                ...
                if (err) {
                    console.log("Initializing BREST extensions failed with error");
                    console.log(err);
                    throw err;
                } else {
                    console.log("Initializing BREST extensions: SUCCESS");
